...
export default function StickyCTA({ onApplyClick }) {
  ...
  return (
    ...
    >
      <div className="w-full bg-gradient-to-r from-[#0F0B1A] to-[#26164A] rounded-t-2xl shadow-[0_15px_40px_rgba(0,0,0,0.25)] border border-[#3F2B6D]/40 pointer-events-auto">
